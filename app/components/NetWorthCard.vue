  ...
  <UCard>
    ...
    <div class="space-y-4">
      ...
      <div>
        ...
        <p class="text-3xl font-bold" :class="data.netWorth.total >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'">
      ...
      <div class="grid grid-cols-2 gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
        ...
        <div>
          <p class="text-sm text-gray-500 dark:text-gray-400 mb-1">Liabilities</p>
      ...
      <div class="space-y-2 pt-4 border-t border-gray-200 dark:border-gray-700">
        <div class="flex items-center justify-between text-sm">
          ...
          <span class="font-medium">{{ formatCurrency(data.netWorth.breakdown.savings) }}</span>
        </div>
        <div class="flex items-center justify-between text-sm">
          <span class="text-gray-600 dark:text-gray-300 flex items-center gap-2">
          ...
          <span class="font-medium">{{ formatCurrency(data.netWorth.breakdown.investments) }}</span>
        </div>
        <div class="flex items-center justify-between text-sm">
          <span class="text-gray-600 dark:text-gray-300 flex items-center gap-2">
          ...
          <span class="font-medium text-red-600 dark:text-red-400">{{ formatCurrency(data.netWorth.breakdown.debt) }}</span>
        </div>
      </div>
    </div>
  </UCard>
