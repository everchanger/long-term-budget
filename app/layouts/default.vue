  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col">
    ...
    <header class="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
          ...
          <div class="flex items-center">
            <NuxtLink to="/" class="flex items-center space-x-2">
              <UIcon name="i-heroicons-chart-bar" class="text-2xl text-blue-600 dark:text-blue-400" />
              <span class="text-xl font-bold text-gray-900 dark:text-white">Budget Planner</span>
            </NuxtLink>
          </div>
          ...
          <div class="flex items-center space-x-4">
            ...
            <template v-if="session">
              ...
              <UButton variant="ghost" icon="i-heroicons-arrow-right-on-rectangle" :loading="isSigningOut"
                @click="handleSignOut">
            ...
            <template v-else>
              ...
              <UButton variant="solid" color="primary" @click="navigateTo('/auth')">
                Sign In
              </UButton>
            </template>

            <!-- Theme toggle -->
            <UButton variant="ghost" icon="i-heroicons-sun" class="dark:hidden"
              @click="$colorMode.preference = 'dark'" />
            <UButton variant="ghost" icon="i-heroicons-moon" class="hidden dark:block"
        ...
        <!-- Mobile Navigation -->
        <div v-show="isMobileMenuOpen" class="md:hidden border-t border-gray-200 dark:border-gray-700 pt-4 pb-3">
          <div class="space-y-1">
            <!-- User info on mobile (when authenticated) -->
            <div v-if="session" class="px-3 py-2 border-b border-gray-200 dark:border-gray-700 mb-2">
              <p class="text-sm text-gray-600 dark:text-gray-300">Signed in as</p>
              <p class="text-sm font-medium text-gray-900 dark:text-white">{{ session.user.name }}</p>
            </div>
            <!-- Sign in button on mobile (when not authenticated) -->
            <div v-else class="px-3 py-2 border-b border-gray-200 dark:border-gray-700 mb-2">
              <UButton variant="solid" color="primary" block @click="navigateTo('/auth'); isMobileMenuOpen = false">
                Sign In
              </UButton>
            </div>
            ...
            <button v-if="session"
              ...
              :disabled="isSigningOut" @click="handleSignOut">
              <UIcon name="i-heroicons-arrow-right-on-rectangle" class="inline mr-2" />
