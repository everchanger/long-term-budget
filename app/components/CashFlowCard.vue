<template>
  <UCard>
    ...
    <div class="space-y-4">
      ...
      <div>
        <p class="text-sm text-gray-500 dark:text-gray-400 mb-1">Monthly Net Cash Flow</p>
        <p class="text-3xl font-bold" :class="data.cashFlow.monthly.netCashFlow >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'">
      ...
      <div class="space-y-3 pt-4 border-t border-gray-200 dark:border-gray-700">
        ...
        <div class="flex items-center justify-between">
          <span class="text-sm text-gray-600 dark:text-gray-300 flex items-center gap-2">
            <UIcon name="i-heroicons-credit-card" class="w-4 h-4 text-orange-500" />
            Debt Payments
          </span>
      ...
      <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
        <p class="text-xs text-gray-500 dark:text-gray-400 mb-2">Annual Net Cash Flow</p>
        <p class="text-lg font-semibold" :class="data.cashFlow.annual.netCashFlow >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'">
